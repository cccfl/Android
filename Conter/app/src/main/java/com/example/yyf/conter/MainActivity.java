package com.example.yyf.conter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
         ...
         * 运算符
         */
        add_btn = (Button) findViewById(R.id.badd);
        subtract_btn = (Button) findViewById(R.id.bsub);
        multiply_btn = (Button) findViewById(R.id.bmul);
        divide_btn = (Button) findViewById(R.id.bdiv);
        equal_btn = (Button) findViewById(R.id.bequal);
        /**
         * 其他
         */
        evolution = (Button) findViewById(R.id.bev);
        negation = (Button) findViewById(R.id.bpm);
        dot_btn = (Button) findViewById(R.id.bdot);
        percent_btn = (Button) findViewById(R.id.bpercent);
        delete_btn = (Button) findViewById(R.id.bdele);
        ac_btn = (Button) findViewById(R.id.bclear);
        /**
         * 结果
         */
    ...
    private void initEvent() {
        ...
        negation.setOnClickListener(this);
            ...
            case R.id.bev:
                ...
                if (existedText.equals("error")){
                    ...
                    if (startWithOperator || startWithSubtract || noStartWithOperator) {
                        ...
                        if (temp<0) {
                            Toast.makeText(this, "此运算不能为负数", Toast.LENGTH_SHORT).show();
                            return;
                        } else {
                            temp = Math.sqrt(temp);
                            existedText = String.valueOf(temp);
                            existedText = subZeroAndDot(existedText);
                            isCounted = true;
                        }
                    }
                }
